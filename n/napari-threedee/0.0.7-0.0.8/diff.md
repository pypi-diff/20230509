# Comparing `tmp/napari-threedee-0.0.7.tar.gz` & `tmp/napari-threedee-0.0.8.tar.gz`
...
## Comparing `napari-threedee-0.0.7.tar` & `napari-threedee-0.0.8.tar`
...
### Comparing `napari-threedee-0.0.7/.github/workflows/test_and_deploy.yml` & `napari-threedee-0.0.8/.github/workflows/test_and_deploy.yml`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/.gitignore` & `napari-threedee-0.0.8/.gitignore`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/LICENSE` & `napari-threedee-0.0.8/LICENSE`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/PKG-INFO` & `napari-threedee-0.0.8/PKG-INFO`
...
### Comparing `napari-threedee-0.0.7/README.md` & `napari-threedee-0.0.8/README.md`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/annotations/io.md` & `napari-threedee-0.0.8/docs/annotations/io.md`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/annotations/point_spec.md` & `napari-threedee-0.0.8/docs/annotations/point_spec.md`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/annotations/specifications.md` & `napari-threedee-0.0.8/docs/annotations/specifications.md`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/annotations/sphere_spec.md` & `napari-threedee-0.0.8/docs/annotations/sphere_spec.md`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/annotations/spline_spec.md` & `napari-threedee-0.0.8/docs/annotations/spline_spec.md`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/dev_guides/core_concepts.md` & `napari-threedee-0.0.8/docs/dev_guides/core_concepts.md`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/dev_guides/manipulators.md` & `napari-threedee-0.0.8/docs/dev_guides/manipulators.md`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/examples/library/camera_spline_library.py` & `napari-threedee-0.0.8/docs/examples/library/camera_spline_library.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/examples/library/mesh_headlight_library.py` & `napari-threedee-0.0.8/docs/examples/library/mesh_headlight_library.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/examples/library/path_annotator_library.py` & `napari-threedee-0.0.8/docs/examples/library/path_annotator_library.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/examples/library/point_annotator_library.py` & `napari-threedee-0.0.8/docs/examples/library/point_annotator_library.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/examples/library/render_plane_manipulator_library.py` & `napari-threedee-0.0.8/docs/examples/library/render_plane_manipulator_library.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/examples/library/sphere_annotator_library.py` & `napari-threedee-0.0.8/docs/examples/library/sphere_annotator_library.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/examples/library/surface_annotator_library.py` & `napari-threedee-0.0.8/docs/examples/library/surface_annotator_library.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/examples/plugin/camera_spline_plugin.py` & `napari-threedee-0.0.8/docs/examples/plugin/camera_spline_plugin.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/examples/plugin/layer_manipulator_plugin.py` & `napari-threedee-0.0.8/docs/examples/plugin/layer_manipulator_plugin.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/examples/plugin/mesh_headlight_plugin.py` & `napari-threedee-0.0.8/docs/examples/plugin/mesh_headlight_plugin.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/examples/plugin/path_annotator_plugin.py` & `napari-threedee-0.0.8/docs/examples/plugin/path_annotator_plugin.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/examples/plugin/point_annotator_plugin.py` & `napari-threedee-0.0.8/docs/examples/plugin/point_annotator_plugin.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/examples/plugin/points_manipulator_plugin.py` & `napari-threedee-0.0.8/docs/examples/plugin/points_manipulator_plugin.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/examples/plugin/render_plane_manipulator_plugin.py` & `napari-threedee-0.0.8/docs/examples/plugin/render_plane_manipulator_plugin.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/examples/plugin/sphere_annotator_plugin.py` & `napari-threedee-0.0.8/docs/examples/plugin/sphere_annotator_plugin.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/examples/plugin/spline_annotator_plugin.py` & `napari-threedee-0.0.8/docs/examples/plugin/spline_annotator_plugin.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/examples/plugin/surface_annotator_plugin.py` & `napari-threedee-0.0.8/docs/examples/plugin/surface_annotator_plugin.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/gallery_conf.py` & `napari-threedee-0.0.8/docs/gallery_conf.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/how_to/layer_manipulator.md` & `napari-threedee-0.0.8/docs/how_to/layer_manipulator.md`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/how_to/point_annotator.md` & `napari-threedee-0.0.8/docs/how_to/point_annotator.md`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/how_to/point_manipulator.md` & `napari-threedee-0.0.8/docs/how_to/point_manipulator.md`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/how_to/render_plane_manipulator.md` & `napari-threedee-0.0.8/docs/how_to/render_plane_manipulator.md`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/how_to/sphere_annotator.md` & `napari-threedee-0.0.8/docs/how_to/sphere_annotator.md`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/how_to/spline_annotator.md` & `napari-threedee-0.0.8/docs/how_to/spline_annotator.md`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/index.md` & `napari-threedee-0.0.8/docs/index.md`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/docs/stylesheets/extra.css` & `napari-threedee-0.0.8/docs/stylesheets/extra.css`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/mkdocs.yml` & `napari-threedee-0.0.8/mkdocs.yml`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/setup.cfg` & `napari-threedee-0.0.8/setup.cfg`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/_backend/manipulator/_tests/test_axis_model.py` & `napari-threedee-0.0.8/src/napari_threedee/_backend/manipulator/_tests/test_axis_model.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/_backend/manipulator/_tests/test_drag_manager.py` & `napari-threedee-0.0.8/src/napari_threedee/_backend/manipulator/_tests/test_drag_manager.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/_backend/manipulator/_tests/test_manipulator.py` & `napari-threedee-0.0.8/src/napari_threedee/_backend/manipulator/_tests/test_manipulator.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/_backend/manipulator/_tests/test_manipulator_visual_data.py` & `napari-threedee-0.0.8/src/napari_threedee/_backend/manipulator/_tests/test_manipulator_visual_data.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/_backend/manipulator/axis_model.py` & `napari-threedee-0.0.8/src/napari_threedee/_backend/manipulator/axis_model.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/_backend/manipulator/central_axis.py` & `napari-threedee-0.0.8/src/napari_threedee/_backend/manipulator/central_axis.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/_backend/manipulator/drag_managers.py` & `napari-threedee-0.0.8/src/napari_threedee/_backend/manipulator/drag_managers.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/_backend/manipulator/manipulator_model.py` & `napari-threedee-0.0.8/src/napari_threedee/_backend/manipulator/manipulator_model.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/_backend/manipulator/napari_manipulator_backend.py` & `napari-threedee-0.0.8/src/napari_threedee/_backend/manipulator/napari_manipulator_backend.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/_backend/manipulator/rotator.py` & `napari-threedee-0.0.8/src/napari_threedee/_backend/manipulator/rotator.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/_backend/manipulator/translator.py` & `napari-threedee-0.0.8/src/napari_threedee/_backend/manipulator/translator.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/_backend/manipulator/utils.py` & `napari-threedee-0.0.8/src/napari_threedee/_backend/manipulator/utils.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/_backend/manipulator/vispy_manipulator_visual.py` & `napari-threedee-0.0.8/src/napari_threedee/_backend/manipulator/vispy_manipulator_visual.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/_backend/manipulator/vispy_visual_data.py` & `napari-threedee-0.0.8/src/napari_threedee/_backend/manipulator/vispy_visual_data.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/_backend/threedee_model.py` & `napari-threedee-0.0.8/src/napari_threedee/_backend/threedee_model.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/_backend/threedee_widget_base.py` & `napari-threedee-0.0.8/src/napari_threedee/_backend/threedee_widget_base.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/_tests/test_dock_widget.py` & `napari-threedee-0.0.8/src/napari_threedee/_tests/test_dock_widget.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/_tests/test_mouse_callbacks.py` & `napari-threedee-0.0.8/src/napari_threedee/_tests/test_mouse_callbacks.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/annotators/_qt/qt_path_annotator.py` & `napari-threedee-0.0.8/src/napari_threedee/annotators/_qt/qt_path_annotator.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/annotators/_qt/qt_surface_annotator.py` & `napari-threedee-0.0.8/src/napari_threedee/annotators/_qt/qt_surface_annotator.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/annotators/_tests/conftest.py` & `napari-threedee-0.0.8/src/napari_threedee/annotators/_tests/conftest.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/annotators/_tests/test_point_annotator.py` & `napari-threedee-0.0.8/src/napari_threedee/annotators/_tests/test_point_annotator.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/annotators/_tests/test_sphere_annotator.py` & `napari-threedee-0.0.8/src/napari_threedee/annotators/_tests/test_sphere_annotator.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/annotators/_tests/test_spline_annotator.py` & `napari-threedee-0.0.8/src/napari_threedee/annotators/_tests/test_spline_annotator.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/annotators/base.py` & `napari-threedee-0.0.8/src/napari_threedee/annotators/base.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/annotators/paths/annotator.py` & `napari-threedee-0.0.8/src/napari_threedee/annotators/paths/annotator.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/annotators/paths/validation.py` & `napari-threedee-0.0.8/src/napari_threedee/annotators/paths/validation.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/annotators/points/annotator.py` & `napari-threedee-0.0.8/src/napari_threedee/annotators/points/annotator.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/annotators/points/validation.py` & `napari-threedee-0.0.8/src/napari_threedee/annotators/points/validation.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/annotators/spheres/_tests/test_data_model.py` & `napari-threedee-0.0.8/src/napari_threedee/annotators/spheres/_tests/test_data_model.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/annotators/spheres/annotator.py` & `napari-threedee-0.0.8/src/napari_threedee/annotators/spheres/annotator.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/annotators/spheres/validation.py` & `napari-threedee-0.0.8/src/napari_threedee/annotators/spheres/validation.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/annotators/surfaces/_tests/test_data_model.py` & `napari-threedee-0.0.8/src/napari_threedee/annotators/surfaces/_tests/test_data_model.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/annotators/surfaces/annotator.py` & `napari-threedee-0.0.8/src/napari_threedee/annotators/surfaces/annotator.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/annotators/surfaces/validation.py` & `napari-threedee-0.0.8/src/napari_threedee/annotators/surfaces/validation.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/conftest.py` & `napari-threedee-0.0.8/src/napari_threedee/conftest.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/data_models/_tests/test_paths.py` & `napari-threedee-0.0.8/src/napari_threedee/data_models/_tests/test_paths.py`
...
### Comparing `napari-threedee-0.0.7/src/napari_threedee/data_models/_tests/test_points.py` & `napari-threedee-0.0.8/src/napari_threedee/data_models/_tests/test_points.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/data_models/paths.py` & `napari-threedee-0.0.8/src/napari_threedee/data_models/paths.py`
...
### Comparing `napari-threedee-0.0.7/src/napari_threedee/data_models/points.py` & `napari-threedee-0.0.8/src/napari_threedee/data_models/points.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/data_models/spheres.py` & `napari-threedee-0.0.8/src/napari_threedee/data_models/spheres.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/data_models/spline_sampler.py` & `napari-threedee-0.0.8/src/napari_threedee/data_models/spline_sampler.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/data_models/surfaces.py` & `napari-threedee-0.0.8/src/napari_threedee/data_models/surfaces.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/manipulators/_tests/test_manipulator_utils.py` & `napari-threedee-0.0.8/src/napari_threedee/manipulators/_tests/test_manipulator_utils.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/manipulators/base_manipulator.py` & `napari-threedee-0.0.8/src/napari_threedee/manipulators/base_manipulator.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/manipulators/layer_manipulator.py` & `napari-threedee-0.0.8/src/napari_threedee/manipulators/layer_manipulator.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/manipulators/manipulator_utils.py` & `napari-threedee-0.0.8/src/napari_threedee/manipulators/manipulator_utils.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/manipulators/point_manipulator.py` & `napari-threedee-0.0.8/src/napari_threedee/manipulators/point_manipulator.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/manipulators/render_plane_manipulator.py` & `napari-threedee-0.0.8/src/napari_threedee/manipulators/render_plane_manipulator.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/napari.yaml` & `napari-threedee-0.0.8/src/napari_threedee/napari.yaml`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/utils/_tests/test_geometry.py` & `napari-threedee-0.0.8/src/napari_threedee/utils/_tests/test_geometry.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/utils/geometry.py` & `napari-threedee-0.0.8/src/napari_threedee/utils/geometry.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/utils/mouse_callbacks.py` & `napari-threedee-0.0.8/src/napari_threedee/utils/mouse_callbacks.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/utils/napari_utils.py` & `napari-threedee-0.0.8/src/napari_threedee/utils/napari_utils.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/utils/selection_utils.py` & `napari-threedee-0.0.8/src/napari_threedee/utils/selection_utils.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/visualization/_qt/qt_camera_spline.py` & `napari-threedee-0.0.8/src/napari_threedee/visualization/_qt/qt_camera_spline.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/visualization/_qt/qt_lighting_control.py` & `napari-threedee-0.0.8/src/napari_threedee/visualization/_qt/qt_lighting_control.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/visualization/_tests/test_camera_spline.py` & `napari-threedee-0.0.8/src/napari_threedee/visualization/_tests/test_camera_spline.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/visualization/_tests/test_lighting_control.py` & `napari-threedee-0.0.8/src/napari_threedee/visualization/_tests/test_lighting_control.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/visualization/camera_spline.py` & `napari-threedee-0.0.8/src/napari_threedee/visualization/camera_spline.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee/visualization/lighting_control.py` & `napari-threedee-0.0.8/src/napari_threedee/visualization/lighting_control.py`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/src/napari_threedee.egg-info/PKG-INFO` & `napari-threedee-0.0.8/src/napari_threedee.egg-info/PKG-INFO`
...
### Comparing `napari-threedee-0.0.7/src/napari_threedee.egg-info/SOURCES.txt` & `napari-threedee-0.0.8/src/napari_threedee.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `napari-threedee-0.0.7/tox.ini` & `napari-threedee-0.0.8/tox.ini`
