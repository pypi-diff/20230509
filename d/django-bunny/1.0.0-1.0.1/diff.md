# Comparing `tmp/django-bunny-1.0.0.tar.gz` & `tmp/django-bunny-1.0.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "django-bunny-1.0.0.tar", max compression
+gzip compressed data, was "django-bunny-1.0.1.tar", max compression
```

## Comparing `django-bunny-1.0.0.tar` & `django-bunny-1.0.1.tar`

### file list

```diff
@@ -1,7 +1,7 @@
--rw-r--r--   0        0        0        0 2023-05-09 02:51:37.446276 django-bunny-1.0.0/django_bunny/__init__.py
--rw-r--r--   0        0        0     5346 2023-05-09 02:45:41.118573 django-bunny-1.0.0/django_bunny/storage.py
--rw-r--r--   0        0        0     1092 2023-05-09 01:04:30.492122 django-bunny-1.0.0/LICENSE
--rw-r--r--   0        0        0      446 2023-05-09 02:48:58.289561 django-bunny-1.0.0/pyproject.toml
--rw-r--r--   0        0        0     2243 2023-05-09 02:51:17.790012 django-bunny-1.0.0/README.md
--rw-r--r--   0        0        0     2918 1970-01-01 00:00:00.000000 django-bunny-1.0.0/setup.py
--rw-r--r--   0        0        0     2809 1970-01-01 00:00:00.000000 django-bunny-1.0.0/PKG-INFO
...
### Comparing `django-bunny-1.0.0/django_bunny/storage.py` & `django-bunny-1.0.1/django_bunny/storage.py`
...
### Comparing `django-bunny-1.0.0/LICENSE` & `django-bunny-1.0.1/LICENSE`

 * *Files identical despite different names*

### Comparing `django-bunny-1.0.0/README.md` & `django-bunny-1.0.1/README.md`

 * *Files identical despite different names*

### Comparing `django-bunny-1.0.0/setup.py` & `django-bunny-1.0.1/setup.py`
...
### Comparing `django-bunny-1.0.0/PKG-INFO` & `django-bunny-1.0.1/PKG-INFO`
