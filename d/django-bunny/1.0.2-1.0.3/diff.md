# Comparing `tmp/django-bunny-1.0.2.tar.gz` & `tmp/django-bunny-1.0.3.tar.gz`
...
## Comparing `django-bunny-1.0.2.tar` & `django-bunny-1.0.3.tar`
...
### Comparing `django-bunny-1.0.2/django_bunny/storage.py` & `django-bunny-1.0.3/django_bunny/storage.py`

 * *Files identical despite different names*

### Comparing `django-bunny-1.0.2/LICENSE` & `django-bunny-1.0.3/LICENSE`

 * *Files identical despite different names*

### Comparing `django-bunny-1.0.2/README.md` & `django-bunny-1.0.3/README.md`

 * *Files identical despite different names*

### Comparing `django-bunny-1.0.2/setup.py` & `django-bunny-1.0.3/setup.py`
...
### Comparing `django-bunny-1.0.2/PKG-INFO` & `django-bunny-1.0.3/PKG-INFO`
