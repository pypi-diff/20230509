# Comparing `tmp/rottentomatoes-python-0.5.16.tar.gz` & `tmp/rottentomatoes-python-0.5.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "rottentomatoes-python-0.5.16.tar", last modified: Tue May  9 00:47:07 2023, max compression
+gzip compressed data, was "rottentomatoes-python-0.5.2.tar", last modified: Mon Feb 13 00:20:25 2023, max compression
```

## Comparing `rottentomatoes-python-0.5.16.tar` & `rottentomatoes-python-0.5.2.tar`

### file list

```diff
@@ -1,26 +1,22 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 00:47:07.086476 rottentomatoes-python-0.5.16/
--rw-r--r--   0 runner    (1001) docker     (123)     8593 2023-05-09 00:47:07.086476 rottentomatoes-python-0.5.16/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     8071 2023-05-09 00:46:46.000000 rottentomatoes-python-0.5.16/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 00:47:07.086476 rottentomatoes-python-0.5.16/api/
--rw-r--r--   0 runner    (1001) docker     (123)     1839 2023-05-09 00:46:46.000000 rottentomatoes-python-0.5.16/api/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     5125 2023-05-09 00:46:46.000000 rottentomatoes-python-0.5.16/api/models.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 00:47:07.086476 rottentomatoes-python-0.5.16/rottentomatoes/
--rw-r--r--   0 runner    (1001) docker     (123)       67 2023-05-09 00:46:46.000000 rottentomatoes-python-0.5.16/rottentomatoes/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)       79 2023-05-09 00:46:46.000000 rottentomatoes-python-0.5.16/rottentomatoes/exceptions.py
--rw-r--r--   0 runner    (1001) docker     (123)     2065 2023-05-09 00:46:46.000000 rottentomatoes-python-0.5.16/rottentomatoes/movie.py
--rw-r--r--   0 runner    (1001) docker     (123)     2813 2023-05-09 00:46:46.000000 rottentomatoes-python-0.5.16/rottentomatoes/search.py
--rw-r--r--   0 runner    (1001) docker     (123)     8205 2023-05-09 00:46:46.000000 rottentomatoes-python-0.5.16/rottentomatoes/standalone.py
--rw-r--r--   0 runner    (1001) docker     (123)      345 2023-05-09 00:46:46.000000 rottentomatoes-python-0.5.16/rottentomatoes/utils.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 00:47:07.086476 rottentomatoes-python-0.5.16/rottentomatoes_python.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     8593 2023-05-09 00:47:07.000000 rottentomatoes-python-0.5.16/rottentomatoes_python.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      511 2023-05-09 00:47:07.000000 rottentomatoes-python-0.5.16/rottentomatoes_python.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-05-09 00:47:07.000000 rottentomatoes-python-0.5.16/rottentomatoes_python.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)        9 2023-05-09 00:47:07.000000 rottentomatoes-python-0.5.16/rottentomatoes_python.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       25 2023-05-09 00:47:07.000000 rottentomatoes-python-0.5.16/rottentomatoes_python.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-05-09 00:47:07.086476 rottentomatoes-python-0.5.16/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)      883 2023-05-09 00:46:46.000000 rottentomatoes-python-0.5.16/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 00:47:07.086476 rottentomatoes-python-0.5.16/tests/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-05-09 00:46:46.000000 rottentomatoes-python-0.5.16/tests/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      371 2023-05-09 00:46:46.000000 rottentomatoes-python-0.5.16/tests/conftest.py
--rw-r--r--   0 runner    (1001) docker     (123)      502 2023-05-09 00:46:46.000000 rottentomatoes-python-0.5.16/tests/test_movie.py
--rw-r--r--   0 runner    (1001) docker     (123)     1639 2023-05-09 00:46:46.000000 rottentomatoes-python-0.5.16/tests/test_standalone.py
...
### Comparing `rottentomatoes-python-0.5.16/PKG-INFO` & `rottentomatoes-python-0.5.2/PKG-INFO`
...
### Comparing `rottentomatoes-python-0.5.16/README.md` & `rottentomatoes-python-0.5.2/README.md`
...
### Comparing `rottentomatoes-python-0.5.16/rottentomatoes/movie.py` & `rottentomatoes-python-0.5.2/rottentomatoes/movie.py`
...
### Comparing `rottentomatoes-python-0.5.16/rottentomatoes/search.py` & `rottentomatoes-python-0.5.2/rottentomatoes/search.py`
...
### Comparing `rottentomatoes-python-0.5.16/rottentomatoes/standalone.py` & `rottentomatoes-python-0.5.2/rottentomatoes/standalone.py`
...
### Comparing `rottentomatoes-python-0.5.16/rottentomatoes_python.egg-info/PKG-INFO` & `rottentomatoes-python-0.5.2/rottentomatoes_python.egg-info/PKG-INFO`
...
### Comparing `rottentomatoes-python-0.5.16/setup.py` & `rottentomatoes-python-0.5.2/setup.py`
