# Comparing `tmp/kalm-0.5.4.tar.gz` & `tmp/kalm-0.5.5.tar.gz`
...
## Comparing `kalm-0.5.4.tar` & `kalm-0.5.5.tar`
...
### Comparing `kalm-0.5.4/LICENSE.txt` & `kalm-0.5.5/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `kalm-0.5.4/pyproject.toml` & `kalm-0.5.5/pyproject.toml`
...
### Comparing `kalm-0.5.4/src/kalm/__init__.py` & `kalm-0.5.5/src/kalm/__init__.py`

 * *Files identical despite different names*

### Comparing `kalm-0.5.4/src/kalm/kalm.py` & `kalm-0.5.5/src/kalm/kalm.py`

 * *Files identical despite different names*

### Comparing `kalm-0.5.4/src/kalm/netbox.py` & `kalm-0.5.5/src/kalm/netbox.py`

 * *Files identical despite different names*

### Comparing `kalm-0.5.4/PKG-INFO` & `kalm-0.5.5/PKG-INFO`
