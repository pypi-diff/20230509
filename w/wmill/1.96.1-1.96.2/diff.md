# Comparing `tmp/wmill-1.96.1.tar.gz` & `tmp/wmill-1.96.2.tar.gz`
...
## Comparing `wmill-1.96.1.tar` & `wmill-1.96.2.tar`
...
### Comparing `wmill-1.96.1/README.md` & `wmill-1.96.2/README.md`

 * *Files identical despite different names*

### Comparing `wmill-1.96.1/pyproject.toml` & `wmill-1.96.2/pyproject.toml`
...
### Comparing `wmill-1.96.1/wmill/client.py` & `wmill-1.96.2/wmill/client.py`

 * *Files identical despite different names*

### Comparing `wmill-1.96.1/setup.py` & `wmill-1.96.2/setup.py`
...
### Comparing `wmill-1.96.1/PKG-INFO` & `wmill-1.96.2/PKG-INFO`
