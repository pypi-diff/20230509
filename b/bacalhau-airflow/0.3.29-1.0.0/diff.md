# Comparing `tmp/bacalhau_airflow-0.3.29.tar.gz` & `tmp/bacalhau_airflow-1.0.0.tar.gz`
...
## Comparing `bacalhau_airflow-0.3.29.tar` & `bacalhau_airflow-1.0.0.tar`
...
### Comparing `bacalhau_airflow-0.3.29/LICENSE` & `bacalhau_airflow-1.0.0/LICENSE`

 * *Files identical despite different names*

### Comparing `bacalhau_airflow-0.3.29/PKG-INFO` & `bacalhau_airflow-1.0.0/PKG-INFO`
...
### Comparing `bacalhau_airflow-0.3.29/README.md` & `bacalhau_airflow-1.0.0/README.md`

 * *Files identical despite different names*

### Comparing `bacalhau_airflow-0.3.29/bacalhau_airflow/hooks.py` & `bacalhau_airflow-1.0.0/bacalhau_airflow/hooks.py`

 * *Files identical despite different names*

### Comparing `bacalhau_airflow-0.3.29/bacalhau_airflow/operators.py` & `bacalhau_airflow-1.0.0/bacalhau_airflow/operators.py`

 * *Files identical despite different names*

### Comparing `bacalhau_airflow-0.3.29/bacalhau_airflow.egg-info/PKG-INFO` & `bacalhau_airflow-1.0.0/bacalhau_airflow.egg-info/PKG-INFO`
...
### Comparing `bacalhau_airflow-0.3.29/bacalhau_airflow.egg-info/SOURCES.txt` & `bacalhau_airflow-1.0.0/bacalhau_airflow.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `bacalhau_airflow-0.3.29/docs/Makefile` & `bacalhau_airflow-1.0.0/docs/Makefile`

 * *Files identical despite different names*

### Comparing `bacalhau_airflow-0.3.29/docs/_static/airflow_01.png` & `bacalhau_airflow-1.0.0/docs/_static/airflow_01.png`

 * *Files identical despite different names*

### Comparing `bacalhau_airflow-0.3.29/docs/_static/airflow_02.png` & `bacalhau_airflow-1.0.0/docs/_static/airflow_02.png`

 * *Files identical despite different names*

### Comparing `bacalhau_airflow-0.3.29/docs/_static/airflow_03.png` & `bacalhau_airflow-1.0.0/docs/_static/airflow_03.png`

 * *Files identical despite different names*

### Comparing `bacalhau_airflow-0.3.29/docs/_static/airflow_04.png` & `bacalhau_airflow-1.0.0/docs/_static/airflow_04.png`

 * *Files identical despite different names*

### Comparing `bacalhau_airflow-0.3.29/docs/bacalhau_airflow.rst` & `bacalhau_airflow-1.0.0/docs/bacalhau_airflow.rst`

 * *Files identical despite different names*

### Comparing `bacalhau_airflow-0.3.29/docs/conf.py` & `bacalhau_airflow-1.0.0/docs/conf.py`

 * *Files identical despite different names*

### Comparing `bacalhau_airflow-0.3.29/docs/index.rst` & `bacalhau_airflow-1.0.0/docs/index.rst`

 * *Files identical despite different names*

### Comparing `bacalhau_airflow-0.3.29/setup.py` & `bacalhau_airflow-1.0.0/setup.py`

 * *Files identical despite different names*

### Comparing `bacalhau_airflow-0.3.29/tests/test_hooks.py` & `bacalhau_airflow-1.0.0/tests/test_hooks.py`

 * *Files identical despite different names*

### Comparing `bacalhau_airflow-0.3.29/tests/test_operators.py` & `bacalhau_airflow-1.0.0/tests/test_operators.py`
