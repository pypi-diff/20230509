# Comparing `tmp/toolplot-0.3.2.tar.gz` & `tmp/toolplot-0.3.3.tar.gz`
...
## Comparing `toolplot-0.3.2.tar` & `toolplot-0.3.3.tar`
...
### Comparing `toolplot-0.3.2/LICENSE` & `toolplot-0.3.3/LICENSE`

 * *Files identical despite different names*

### Comparing `toolplot-0.3.2/toolplot/plot_create.py` & `toolplot-0.3.3/toolplot/plot_create.py`

 * *Files identical despite different names*

### Comparing `toolplot-0.3.2/toolplot/plot_save.py` & `toolplot-0.3.3/toolplot/plot_save.py`

 * *Files identical despite different names*

### Comparing `toolplot-0.3.2/toolplot/plot_setup.py` & `toolplot-0.3.3/toolplot/plot_setup.py`

 * *Files identical despite different names*

### Comparing `toolplot-0.3.2/toolplot/plot_ticks.py` & `toolplot-0.3.3/toolplot/plot_ticks.py`

 * *Files identical despite different names*

### Comparing `toolplot-0.3.2/toolplot/special_plots/bar_plots.py` & `toolplot-0.3.3/toolplot/special_plots/bar_plots.py`

 * *Files identical despite different names*

### Comparing `toolplot-0.3.2/toolplot/special_plots/candlestick_plots.py` & `toolplot-0.3.3/toolplot/special_plots/candlestick_plots.py`

 * *Files identical despite different names*

### Comparing `toolplot-0.3.2/toolplot/special_plots/log_histograms.py` & `toolplot-0.3.3/toolplot/special_plots/log_histograms.py`

 * *Files identical despite different names*

### Comparing `toolplot-0.3.2/PKG-INFO` & `toolplot-0.3.3/PKG-INFO`
