# Comparing `tmp/tumfl-0.1.4.tar.gz` & `tmp/tumfl-0.1.5.tar.gz`
...
## Comparing `tumfl-0.1.4.tar` & `tumfl-0.1.5.tar`
...
### Comparing `tumfl-0.1.4/PKG-INFO` & `tumfl-0.1.5/PKG-INFO`
...
### Comparing `tumfl-0.1.4/pyproject.toml` & `tumfl-0.1.5/pyproject.toml`
...
### Comparing `tumfl-0.1.4/test/test_lexer.py` & `tumfl-0.1.5/test/test_lexer.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/test/test_parser.py` & `tumfl-0.1.5/test/test_parser.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/AST/ASTNode.py` & `tumfl-0.1.5/tumfl/AST/ASTNode.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/AST/BaseFunctionDefinition.py` & `tumfl-0.1.5/tumfl/AST/BaseFunctionDefinition.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/AST/Expression/BinOp.py` & `tumfl-0.1.5/tumfl/AST/Expression/BinOp.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/AST/Expression/ExpFunctionDefinition.py` & `tumfl-0.1.5/tumfl/AST/Expression/ExpFunctionDefinition.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/AST/Expression/ExpMethodInvocation.py` & `tumfl-0.1.5/tumfl/AST/Expression/ExpMethodInvocation.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/AST/Expression/Name.py` & `tumfl-0.1.5/tumfl/AST/Expression/Name.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/AST/Expression/Number.py` & `tumfl-0.1.5/tumfl/AST/Expression/Number.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/AST/Expression/String.py` & `tumfl-0.1.5/tumfl/AST/Expression/String.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/AST/Expression/TableField.py` & `tumfl-0.1.5/tumfl/AST/Expression/TableField.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/AST/Expression/UnOp.py` & `tumfl-0.1.5/tumfl/AST/Expression/UnOp.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/AST/Expression/__init__.py` & `tumfl-0.1.5/tumfl/AST/Expression/__init__.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/AST/Statement/Assign.py` & `tumfl-0.1.5/tumfl/AST/Statement/Assign.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/AST/Statement/FunctionCall.py` & `tumfl-0.1.5/tumfl/AST/Statement/FunctionCall.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/AST/Statement/FunctionDefinition.py` & `tumfl-0.1.5/tumfl/AST/Statement/FunctionDefinition.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/AST/Statement/If.py` & `tumfl-0.1.5/tumfl/AST/Statement/If.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/AST/Statement/IterativeFor.py` & `tumfl-0.1.5/tumfl/AST/Statement/IterativeFor.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/AST/Statement/LocalAssign.py` & `tumfl-0.1.5/tumfl/AST/Statement/LocalAssign.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/AST/Statement/LocalFunctionDefinition.py` & `tumfl-0.1.5/tumfl/AST/Statement/LocalFunctionDefinition.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/AST/Statement/MethodInvocation.py` & `tumfl-0.1.5/tumfl/AST/Statement/MethodInvocation.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/AST/Statement/NumericFor.py` & `tumfl-0.1.5/tumfl/AST/Statement/NumericFor.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/AST/Statement/__init__.py` & `tumfl-0.1.5/tumfl/AST/Statement/__init__.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/Token.py` & `tumfl-0.1.5/tumfl/Token.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/basic_walker.py` & `tumfl-0.1.5/tumfl/basic_walker.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/error.py` & `tumfl-0.1.5/tumfl/error.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/formatter.py` & `tumfl-0.1.5/tumfl/formatter.py`
...
### Comparing `tumfl-0.1.4/tumfl/lexer.py` & `tumfl-0.1.5/tumfl/lexer.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl/parser.py` & `tumfl-0.1.5/tumfl/parser.py`
...
### Comparing `tumfl-0.1.4/tumfl/utils.py` & `tumfl-0.1.5/tumfl/utils.py`

 * *Files identical despite different names*

### Comparing `tumfl-0.1.4/tumfl.egg-info/PKG-INFO` & `tumfl-0.1.5/tumfl.egg-info/PKG-INFO`
...
### Comparing `tumfl-0.1.4/tumfl.egg-info/SOURCES.txt` & `tumfl-0.1.5/tumfl.egg-info/SOURCES.txt`
