# Comparing `tmp/tencentcloud-sdk-python-iir-3.0.886.tar.gz` & `tmp/tencentcloud-sdk-python-iir-3.0.887.tar.gz`
...
## Comparing `tencentcloud-sdk-python-iir-3.0.886.tar` & `tencentcloud-sdk-python-iir-3.0.887.tar`
...
### Comparing `tencentcloud-sdk-python-iir-3.0.886/README.rst` & `tencentcloud-sdk-python-iir-3.0.887/README.rst`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-iir-3.0.886/tencentcloud/__init__.py` & `tencentcloud-sdk-python-iir-3.0.887/tencentcloud/__init__.py`
...
### Comparing `tencentcloud-sdk-python-iir-3.0.886/tencentcloud/iir/v20200417/errorcodes.py` & `tencentcloud-sdk-python-iir-3.0.887/tencentcloud/iir/v20200417/errorcodes.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-iir-3.0.886/tencentcloud/iir/v20200417/models.py` & `tencentcloud-sdk-python-iir-3.0.887/tencentcloud/iir/v20200417/models.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-iir-3.0.886/tencentcloud/iir/v20200417/iir_client.py` & `tencentcloud-sdk-python-iir-3.0.887/tencentcloud/iir/v20200417/iir_client.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-iir-3.0.886/PKG-INFO` & `tencentcloud-sdk-python-iir-3.0.887/PKG-INFO`
...
### Comparing `tencentcloud-sdk-python-iir-3.0.886/setup.py` & `tencentcloud-sdk-python-iir-3.0.887/setup.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-iir-3.0.886/tencentcloud_sdk_python_iir.egg-info/PKG-INFO` & `tencentcloud-sdk-python-iir-3.0.887/tencentcloud_sdk_python_iir.egg-info/PKG-INFO`
