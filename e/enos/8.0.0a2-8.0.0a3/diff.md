# Comparing `tmp/enos-8.0.0a2.tar.gz` & `tmp/enos-8.0.0a3.tar.gz`
...
## Comparing `enos-8.0.0a2.tar` & `enos-8.0.0a3.tar`
...
### Comparing `enos-8.0.0a2/LICENSE` & `enos-8.0.0a3/LICENSE`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/README.rst` & `enos-8.0.0a3/README.rst`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/ansible/enos.yml` & `enos-8.0.0a3/enos/ansible/enos.yml`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/ansible/plugins/callback/influxdb_events.py` & `enos-8.0.0a3/enos/ansible/plugins/callback/influxdb_events.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/ansible/roles/cadvisor/tasks/deploy.yml` & `enos-8.0.0a3/enos/ansible/roles/cadvisor/tasks/deploy.yml`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/ansible/roles/collectd/files/collectd.conf` & `enos-8.0.0a3/enos/ansible/roles/collectd/files/collectd.conf`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/ansible/roles/collectd/files/haproxy.py` & `enos-8.0.0a3/enos/ansible/roles/collectd/files/haproxy.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/ansible/roles/collectd/tasks/deploy.yml` & `enos-8.0.0a3/enos/ansible/roles/collectd/tasks/deploy.yml`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/ansible/roles/collectd/templates/rabbitmq.conf.j2` & `enos-8.0.0a3/enos/ansible/roles/collectd/templates/rabbitmq.conf.j2`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/ansible/roles/grafana/tasks/deploy.yml` & `enos-8.0.0a3/enos/ansible/roles/grafana/tasks/deploy.yml`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/ansible/roles/influx/files/config.toml` & `enos-8.0.0a3/enos/ansible/roles/influx/files/config.toml`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/ansible/roles/influx/files/types.db` & `enos-8.0.0a3/enos/ansible/roles/influx/files/types.db`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/ansible/roles/influx/tasks/deploy.yml` & `enos-8.0.0a3/enos/ansible/roles/influx/tasks/deploy.yml`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/ansible/roles/init_os/tasks/deploy.yml` & `enos-8.0.0a3/enos/ansible/roles/init_os/tasks/deploy.yml`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/ansible/roles/init_os/templates/init.sh.j2` & `enos-8.0.0a3/enos/ansible/roles/init_os/templates/init.sh.j2`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/cli.py` & `enos-8.0.0a3/enos/cli.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/provider/chameleonbaremetal.py` & `enos-8.0.0a3/enos/provider/chameleonbaremetal.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/provider/chameleonkvm.py` & `enos-8.0.0a3/enos/provider/chameleonkvm.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/provider/enos_vagrant.py` & `enos-8.0.0a3/enos/provider/enos_vagrant.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/provider/g5k.py` & `enos-8.0.0a3/enos/provider/g5k.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/provider/host.py` & `enos-8.0.0a3/enos/provider/host.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/provider/openstack.py` & `enos-8.0.0a3/enos/provider/openstack.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/provider/provider.py` & `enos-8.0.0a3/enos/provider/provider.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/provider/static.py` & `enos-8.0.0a3/enos/provider/static.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/provider/vmong5k.py` & `enos-8.0.0a3/enos/provider/vmong5k.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/resources/inventory.sample` & `enos-8.0.0a3/enos/resources/inventory.sample`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/resources/multinode` & `enos-8.0.0a3/enos/resources/multinode`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/resources/passwords.yml` & `enos-8.0.0a3/enos/resources/passwords.yml`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/resources/workload/create-and-update-image.yaml` & `enos-8.0.0a3/enos/resources/workload/create-and-update-image.yaml`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/resources/workload/nova-boot-list-cc.yml` & `enos-8.0.0a3/enos/resources/workload/nova-boot-list-cc.yml`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/resources/workload/run.yml` & `enos-8.0.0a3/enos/resources/workload/run.yml`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/services/kolla.py` & `enos-8.0.0a3/enos/services/kolla.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/services/rally.py` & `enos-8.0.0a3/enos/services/rally.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/services/shaker.py` & `enos-8.0.0a3/enos/services/shaker.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/tasks/__init__.py` & `enos-8.0.0a3/enos/tasks/__init__.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/tasks/new.py` & `enos-8.0.0a3/enos/tasks/new.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/tasks/up.py` & `enos-8.0.0a3/enos/tasks/up.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/templates/Vagrantfile.j2` & `enos-8.0.0a3/enos/templates/Vagrantfile.j2`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/templates/grafana_dashboard.json` & `enos-8.0.0a3/enos/templates/grafana_dashboard.json`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/templates/reservation.yaml.j2` & `enos-8.0.0a3/enos/templates/reservation.yaml.j2`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/utils/build.py` & `enos-8.0.0a3/enos/utils/build.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/utils/cli.py` & `enos-8.0.0a3/enos/utils/cli.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/utils/constants.py` & `enos-8.0.0a3/enos/utils/constants.py`
...
### Comparing `enos-8.0.0a2/enos/utils/errors.py` & `enos-8.0.0a3/enos/utils/errors.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/enos/utils/extra.py` & `enos-8.0.0a3/enos/utils/extra.py`

 * *Files identical despite different names*

### Comparing `enos-8.0.0a2/pyproject.toml` & `enos-8.0.0a3/pyproject.toml`
...
### Comparing `enos-8.0.0a2/PKG-INFO` & `enos-8.0.0a3/PKG-INFO`
