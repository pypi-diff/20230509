# Comparing `tmp/venakatest-0.1.34.tar.gz` & `tmp/venakatest-0.1.35.tar.gz`
...
## Comparing `venakatest-0.1.34.tar` & `venakatest-0.1.35.tar`
...
### Comparing `venakatest-0.1.34/venakatest/test.py` & `venakatest-0.1.35/venakatest/test.py`
