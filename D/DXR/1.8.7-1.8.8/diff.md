# Comparing `tmp/DXR-1.8.7.tar.gz` & `tmp/DXR-1.8.8.tar.gz`
...
## Comparing `DXR-1.8.7.tar` & `DXR-1.8.8.tar`
...
### Comparing `DXR-1.8.7/DXR.egg-info/SOURCES.txt` & `DXR-1.8.8/DXR.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_Chat/ChatGPT.py` & `DXR-1.8.8/Dxr_Chat/ChatGPT.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_Chat/utils.py` & `DXR-1.8.8/Dxr_Chat/utils.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_bytes/Dxr_bytes.py` & `DXR-1.8.8/Dxr_bytes/Dxr_bytes.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_file/dxr_file.py` & `DXR-1.8.8/Dxr_file/dxr_file.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_file/dxr_request.py` & `DXR-1.8.8/Dxr_file/dxr_request.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_file/dxr_request_ros.py` & `DXR-1.8.8/Dxr_file/dxr_request_ros.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_file/dxr_requests.py` & `DXR-1.8.8/Dxr_file/dxr_requests.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_file/dxr_ssh.py` & `DXR-1.8.8/Dxr_file/dxr_ssh.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_grpc/Datas_pb2.py` & `DXR-1.8.8/Dxr_grpc/Datas_pb2.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_grpc/Datas_pb2_grpc.py` & `DXR-1.8.8/Dxr_grpc/Datas_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_grpc/audios_pb2.py` & `DXR-1.8.8/Dxr_grpc/audios_pb2.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_grpc/audios_pb2_grpc.py` & `DXR-1.8.8/Dxr_grpc/audios_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_grpc/dxr_grpc_audio_client.py` & `DXR-1.8.8/Dxr_grpc/dxr_grpc_audio_client.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_grpc/dxr_grpc_audio_server.py` & `DXR-1.8.8/Dxr_grpc/dxr_grpc_audio_server.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_grpc/dxr_grpc_client.py` & `DXR-1.8.8/Dxr_grpc/dxr_grpc_client.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_grpc/dxr_grpc_server.py` & `DXR-1.8.8/Dxr_grpc/dxr_grpc_server.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_isapi/api.py` & `DXR-1.8.8/Dxr_isapi/api.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_isapi/error.py` & `DXR-1.8.8/Dxr_isapi/error.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_isapi/ir_client.py` & `DXR-1.8.8/Dxr_isapi/ir_client.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_log/log.py` & `DXR-1.8.8/Dxr_log/log.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_mqtt/dxr_mqtt.py` & `DXR-1.8.8/Dxr_mqtt/dxr_mqtt.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_mqtt/dxr_mqtt_2.py` & `DXR-1.8.8/Dxr_mqtt/dxr_mqtt_2.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_mqtt/msg.py` & `DXR-1.8.8/Dxr_mqtt/msg.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_redis/redis_client.py` & `DXR-1.8.8/Dxr_redis/redis_client.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_serial/Dxr_serial.py` & `DXR-1.8.8/Dxr_serial/Dxr_serial.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_utils/dxr_ftp.py` & `DXR-1.8.8/Dxr_utils/dxr_ftp.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_utils/dxr_utils.py` & `DXR-1.8.8/Dxr_utils/dxr_utils.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_video/Datas_pb2.py` & `DXR-1.8.8/Dxr_video/Datas_pb2.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_video/Datas_pb2_grpc.py` & `DXR-1.8.8/Dxr_video/Datas_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_video/HCNetSDK.py` & `DXR-1.8.8/Dxr_video/HCNetSDK.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_video/PlayCtrl.py` & `DXR-1.8.8/Dxr_video/PlayCtrl.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_video/test_main.py` & `DXR-1.8.8/Dxr_video/test_main.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_video/video.py` & `DXR-1.8.8/Dxr_video/video.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_video/video_hk.py` & `DXR-1.8.8/Dxr_video/video_hk.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_video/video_server.py` & `DXR-1.8.8/Dxr_video/video_server.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_voice/dxr_tts.py` & `DXR-1.8.8/Dxr_voice/dxr_tts.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/Dxr_yaml/Dxr_yaml.py` & `DXR-1.8.8/Dxr_yaml/Dxr_yaml.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/README.md` & `DXR-1.8.8/README.md`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/dxr_cli/ChatGPT.py` & `DXR-1.8.8/dxr_cli/ChatGPT.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/dxr_cli/cli.py` & `DXR-1.8.8/dxr_cli/cli.py`
...
### Comparing `DXR-1.8.7/dxr_cli/code_execution.py` & `DXR-1.8.8/dxr_cli/code_execution.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/dxr_cli/utils.py` & `DXR-1.8.8/dxr_cli/utils.py`

 * *Files identical despite different names*

### Comparing `DXR-1.8.7/setup.py` & `DXR-1.8.8/setup.py`
