# Comparing `tmp/KeyboardPaster-0.1.3.tar.gz` & `tmp/KeyboardPaster-0.1.4.tar.gz`
...
## Comparing `KeyboardPaster-0.1.3.tar` & `KeyboardPaster-0.1.4.tar`
...
### Comparing `KeyboardPaster-0.1.3/KeyboardPaster.egg-info/PKG-INFO` & `KeyboardPaster-0.1.4/KeyboardPaster.egg-info/PKG-INFO`
...
### Comparing `KeyboardPaster-0.1.3/PKG-INFO` & `KeyboardPaster-0.1.4/PKG-INFO`
...
### Comparing `KeyboardPaster-0.1.3/keyboardpaster/app.py` & `KeyboardPaster-0.1.4/keyboardpaster/app.py`
...
### Comparing `KeyboardPaster-0.1.3/keyboardpaster/keyboard_layout_detector.py` & `KeyboardPaster-0.1.4/keyboardpaster/keyboard_layout_detector.py`

 * *Files identical despite different names*

### Comparing `KeyboardPaster-0.1.3/setup.py` & `KeyboardPaster-0.1.4/setup.py`
