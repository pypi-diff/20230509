# Comparing `tmp/aeppl-nightly-0.1.4.dev20230507.tar.gz` & `tmp/aeppl-nightly-0.1.4.dev20230508.tar.gz`
...
## Comparing `aeppl-nightly-0.1.4.dev20230507.tar` & `aeppl-nightly-0.1.4.dev20230508.tar`
...
### Comparing `aeppl-nightly-0.1.4.dev20230507/LICENSE` & `aeppl-nightly-0.1.4.dev20230508/LICENSE`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/PKG-INFO` & `aeppl-nightly-0.1.4.dev20230508/PKG-INFO`
...
### Comparing `aeppl-nightly-0.1.4.dev20230507/README.md` & `aeppl-nightly-0.1.4.dev20230508/README.md`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/aeppl/abstract.py` & `aeppl-nightly-0.1.4.dev20230508/aeppl/abstract.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/aeppl/censoring.py` & `aeppl-nightly-0.1.4.dev20230508/aeppl/censoring.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/aeppl/convolutions.py` & `aeppl-nightly-0.1.4.dev20230508/aeppl/convolutions.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/aeppl/cumsum.py` & `aeppl-nightly-0.1.4.dev20230508/aeppl/cumsum.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/aeppl/dists.py` & `aeppl-nightly-0.1.4.dev20230508/aeppl/dists.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/aeppl/joint_logprob.py` & `aeppl-nightly-0.1.4.dev20230508/aeppl/joint_logprob.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/aeppl/logprob.py` & `aeppl-nightly-0.1.4.dev20230508/aeppl/logprob.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/aeppl/mixture.py` & `aeppl-nightly-0.1.4.dev20230508/aeppl/mixture.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/aeppl/printing.py` & `aeppl-nightly-0.1.4.dev20230508/aeppl/printing.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/aeppl/rewriting.py` & `aeppl-nightly-0.1.4.dev20230508/aeppl/rewriting.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/aeppl/scan.py` & `aeppl-nightly-0.1.4.dev20230508/aeppl/scan.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/aeppl/tensor.py` & `aeppl-nightly-0.1.4.dev20230508/aeppl/tensor.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/aeppl/transforms.py` & `aeppl-nightly-0.1.4.dev20230508/aeppl/transforms.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/aeppl/utils.py` & `aeppl-nightly-0.1.4.dev20230508/aeppl/utils.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/aeppl_nightly.egg-info/PKG-INFO` & `aeppl-nightly-0.1.4.dev20230508/aeppl_nightly.egg-info/PKG-INFO`
...
### Comparing `aeppl-nightly-0.1.4.dev20230507/aeppl_nightly.egg-info/SOURCES.txt` & `aeppl-nightly-0.1.4.dev20230508/aeppl_nightly.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/setup.cfg` & `aeppl-nightly-0.1.4.dev20230508/setup.cfg`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/setup.py` & `aeppl-nightly-0.1.4.dev20230508/setup.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/tests/test_abstract.py` & `aeppl-nightly-0.1.4.dev20230508/tests/test_abstract.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/tests/test_censoring.py` & `aeppl-nightly-0.1.4.dev20230508/tests/test_censoring.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/tests/test_composite_logprob.py` & `aeppl-nightly-0.1.4.dev20230508/tests/test_composite_logprob.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/tests/test_convolutions.py` & `aeppl-nightly-0.1.4.dev20230508/tests/test_convolutions.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/tests/test_cumsum.py` & `aeppl-nightly-0.1.4.dev20230508/tests/test_cumsum.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/tests/test_dist.py` & `aeppl-nightly-0.1.4.dev20230508/tests/test_dist.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/tests/test_joint_logprob.py` & `aeppl-nightly-0.1.4.dev20230508/tests/test_joint_logprob.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/tests/test_logprob.py` & `aeppl-nightly-0.1.4.dev20230508/tests/test_logprob.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/tests/test_mixture.py` & `aeppl-nightly-0.1.4.dev20230508/tests/test_mixture.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/tests/test_printing.py` & `aeppl-nightly-0.1.4.dev20230508/tests/test_printing.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/tests/test_rewriting.py` & `aeppl-nightly-0.1.4.dev20230508/tests/test_rewriting.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/tests/test_scan.py` & `aeppl-nightly-0.1.4.dev20230508/tests/test_scan.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/tests/test_tensor.py` & `aeppl-nightly-0.1.4.dev20230508/tests/test_tensor.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/tests/test_transforms.py` & `aeppl-nightly-0.1.4.dev20230508/tests/test_transforms.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/tests/test_utils.py` & `aeppl-nightly-0.1.4.dev20230508/tests/test_utils.py`

 * *Files identical despite different names*

### Comparing `aeppl-nightly-0.1.4.dev20230507/versioneer.py` & `aeppl-nightly-0.1.4.dev20230508/versioneer.py`
