# Comparing `tmp/lspsp-1.0.1.tar.gz` & `tmp/lspsp-1.0.2.tar.gz`
...
+gzip compressed data, was "lspsp-1.0.2.tar", last modified: Tue May  9 03:33:50 2023, max compression
```

## Comparing `lspsp-1.0.1.tar` & `lspsp-1.0.2.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 03:33:50.683154 lspsp-1.0.2/
+-rw-r--r--   0 runner    (1001) docker     (123)       30 2023-05-09 03:33:37.000000 lspsp-1.0.2/MANIFEST.in
+-rw-r--r--   0 runner    (1001) docker     (123)      128 2023-05-09 03:33:50.683154 lspsp-1.0.2/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)       25 2023-05-09 03:33:37.000000 lspsp-1.0.2/README.md
+-rw-r--r--   0 runner    (1001) docker     (123)      401 2023-05-09 03:33:37.000000 lspsp-1.0.2/config.json.template
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 03:33:50.679154 lspsp-1.0.2/lspsp/
+-rw-r--r--   0 runner    (1001) docker     (123)        0 2023-05-09 03:33:37.000000 lspsp-1.0.2/lspsp/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)      262 2023-05-09 03:33:37.000000 lspsp-1.0.2/lspsp/executable.py
+-rw-r--r--   0 runner    (1001) docker     (123)     1733 2023-05-09 03:33:37.000000 lspsp-1.0.2/lspsp/lspmon.py
+-rw-r--r--   0 runner    (1001) docker     (123)     1642 2023-05-09 03:33:37.000000 lspsp-1.0.2/lspsp/lspnotify.py
+-rw-r--r--   0 runner    (1001) docker     (123)     1100 2023-05-09 03:33:37.000000 lspsp-1.0.2/lspsp/lspsp.py
+-rw-r--r--   0 runner    (1001) docker     (123)      752 2023-05-09 03:33:37.000000 lspsp-1.0.2/lspsp/mailbuilder.py
+-rw-r--r--   0 runner    (1001) docker     (123)      173 2023-05-09 03:33:37.000000 lspsp-1.0.2/lspsp/main.py
+-rw-r--r--   0 runner    (1001) docker     (123)      895 2023-05-09 03:33:37.000000 lspsp-1.0.2/lspsp/monexec.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 03:33:50.683154 lspsp-1.0.2/lspsp/resource/
+-rw-r--r--   0 runner    (1001) docker     (123)     3595 2023-05-09 03:33:37.000000 lspsp-1.0.2/lspsp/resource/mail.html
+-rw-r--r--   0 runner    (1001) docker     (123)     3262 2023-05-09 03:33:37.000000 lspsp-1.0.2/lspsp/resource/test.html
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 03:33:50.683154 lspsp-1.0.2/lspsp.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (123)      128 2023-05-09 03:33:50.000000 lspsp-1.0.2/lspsp.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      417 2023-05-09 03:33:50.000000 lspsp-1.0.2/lspsp.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-05-09 03:33:50.000000 lspsp-1.0.2/lspsp.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       42 2023-05-09 03:33:50.000000 lspsp-1.0.2/lspsp.egg-info/entry_points.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       93 2023-05-09 03:33:50.000000 lspsp-1.0.2/lspsp.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        6 2023-05-09 03:33:50.000000 lspsp-1.0.2/lspsp.egg-info/top_level.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       38 2023-05-09 03:33:50.683154 lspsp-1.0.2/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (123)      648 2023-05-09 03:33:37.000000 lspsp-1.0.2/setup.py
```

### Comparing `lspsp-1.0.1/lspsp/lspmon.py` & `lspsp-1.0.2/lspsp/lspmon.py`
...
### Comparing `lspsp-1.0.1/lspsp/lspnotify.py` & `lspsp-1.0.2/lspsp/lspnotify.py`
...
### Comparing `lspsp-1.0.1/lspsp/lspsp.py` & `lspsp-1.0.2/lspsp/lspsp.py`

 * *Files identical despite different names*

### Comparing `lspsp-1.0.1/setup.py` & `lspsp-1.0.2/setup.py`
