# Comparing `tmp/forust-0.2.5.tar.gz` & `tmp/forust-0.2.6.tar.gz`

## Comparing `forust-0.2.5.tar` & `forust-0.2.6.tar`
...
### Comparing `forust-0.2.5/local_dependencies/forust-ml/.github/workflows/CI.yml` & `forust-0.2.6/local_dependencies/forust-ml/.github/workflows/CI.yml`
...
### Comparing `forust-0.2.5/local_dependencies/forust-ml/LICENSE` & `forust-0.2.6/local_dependencies/forust-ml/LICENSE`
...
### Comparing `forust-0.2.5/local_dependencies/forust-ml/README.md` & `forust-0.2.6/PKG-INFO`
...
@@ -129,29 +140,35 @@
 with the effects of all features averaged out. This information gives an
 estimate of how a given feature impacts the model. The `partial_dependence`
 method takes the following parameters... - `X` ***(FrameLike)***: Either a
 pandas DataFrame, or a 2 dimensional numpy array. This should be the same data
 passed into the models fit, or predict, with the columns in the same order. -
 `feature` ***(Union[str, int])***: The feature for which to calculate the
 partial dependence values. This can be the name of a column, if the provided X
-is a pandas DataFrame, or the index of the feature. This method returns a 2
-dimensional numpy array, where the first column is the sorted unique values of
-the feature, and then the second column is the partial dependence values for
-each feature value. This information can be plotted to visualize how a feature
-is used in the model, like so. ```python from seaborn import lineplot import
...
-("model_path.json") ```
+is a pandas DataFrame, or the index of the feature. - `samples` ***(int | None,
+optional)***: Number of evenly spaced samples to select. If None is passed all
+unique values will be used. Defaults to 100. - `exclude_missing` ***(bool,
+optional)***: Should missing excluded from the features? Defaults to True. -
+`percentile_bounds` ***(tuple[float, float], optional)***: Upper and lower
+percentiles to start at when calculating the samples. Defaults to (0.2, 0.98)
+to cap the samples selected at the 5th and 95th percentiles respectively. This
+method returns a 2 dimensional numpy array, where the first column is the
+sorted unique values of the feature, and then the second column is the partial
+dependence values for each feature value. This information can be plotted to
+visualize how a feature is used in the model, like so. ```python from seaborn
+import lineplot import matplotlib.pyplot as plt pd_values =
+model.partial_dependence(X=X, feature="age", samples=None) fig = lineplot
+(x=pd_values[:,0], y=pd_values[:,1],) plt.title("Partial Dependence Plot")
+plt.xlabel("Age") plt.ylabel("Log Odds") ``` [https://github.com/jinlow/forust/
+raw/main/resources/pdp_plot_age.png] We can see how this is impacted if a model
+is created, where a specific constraint is applied to the feature using the
+`monotone_constraint` parameter. ```python model = GradientBooster
+( objective_type="LogLoss", monotone_constraints={"age": -1}, ) model.fit(X, y)
+pd_values = model.partial_dependence(X=X, feature="age") fig = lineplot
+( x=pd_values[:, 0], y=pd_values[:, 1], ) plt.title("Partial Dependence Plot
+with Monotonicity") plt.xlabel("Age") plt.ylabel("Log Odds") ``` [https://
...
+path. loaded_model = GradientBooster.load_model("model_path.json") ```
```

### Comparing `forust-0.2.5/local_dependencies/forust-ml/benches/forust_benchmarks.rs` & `forust-0.2.6/local_dependencies/forust-ml/benches/forust_benchmarks.rs`
...
### Comparing `forust-0.2.5/local_dependencies/forust-ml/resources/pdp_plot_age.png` & `forust-0.2.6/local_dependencies/forust-ml/resources/pdp_plot_age.png`

 * *Files identical despite different names*

### Comparing `forust-0.2.5/local_dependencies/forust-ml/resources/pdp_plot_age_mono.png` & `forust-0.2.6/local_dependencies/forust-ml/resources/pdp_plot_age_mono.png`

 * *Files identical despite different names*

### Comparing `forust-0.2.5/local_dependencies/forust-ml/resources/titanic.csv` & `forust-0.2.6/local_dependencies/forust-ml/resources/titanic.csv`
...
### Comparing `forust-0.2.5/local_dependencies/forust-ml/resources/tree-image-crop.png` & `forust-0.2.6/local_dependencies/forust-ml/resources/tree-image-crop.png`

 * *Files identical despite different names*

### Comparing `forust-0.2.5/local_dependencies/forust-ml/rs-example.md` & `forust-0.2.6/local_dependencies/forust-ml/rs-example.md`
...
### Comparing `forust-0.2.5/local_dependencies/forust-ml/scripts/make_resources.py` & `forust-0.2.6/local_dependencies/forust-ml/scripts/make_resources.py`
...
### Comparing `forust-0.2.5/local_dependencies/forust-ml/src/data.rs` & `forust-0.2.6/local_dependencies/forust-ml/src/data.rs`
...
### Comparing `forust-0.2.5/local_dependencies/forust-ml/src/errors.rs` & `forust-0.2.6/local_dependencies/forust-ml/src/errors.rs`
...
### Comparing `forust-0.2.5/local_dependencies/forust-ml/src/gradientbooster.rs` & `forust-0.2.6/local_dependencies/forust-ml/src/gradientbooster.rs`
...
### Comparing `forust-0.2.5/local_dependencies/forust-ml/src/histogram.rs` & `forust-0.2.6/local_dependencies/forust-ml/src/histogram.rs`
...
### Comparing `forust-0.2.5/local_dependencies/forust-ml/src/node.rs` & `forust-0.2.6/local_dependencies/forust-ml/src/node.rs`
...
### Comparing `forust-0.2.5/local_dependencies/forust-ml/src/objective.rs` & `forust-0.2.6/local_dependencies/forust-ml/src/objective.rs`
...
### Comparing `forust-0.2.5/local_dependencies/forust-ml/src/partial_dependence.rs` & `forust-0.2.6/local_dependencies/forust-ml/src/partial_dependence.rs`
...
### Comparing `forust-0.2.5/local_dependencies/forust-ml/src/splitter.rs` & `forust-0.2.6/local_dependencies/forust-ml/src/splitter.rs`
...
### Comparing `forust-0.2.5/local_dependencies/forust-ml/src/tree.rs` & `forust-0.2.6/local_dependencies/forust-ml/src/tree.rs`
...
### Comparing `forust-0.2.5/local_dependencies/forust-ml/src/utils.rs` & `forust-0.2.6/local_dependencies/forust-ml/src/utils.rs`
...
### Comparing `forust-0.2.5/README.md` & `forust-0.2.6/local_dependencies/forust-ml/README.md`
...
### Comparing `forust-0.2.5/forust/__init__.py` & `forust-0.2.6/forust/__init__.py`
...
### Comparing `forust-0.2.5/pyproject.toml` & `forust-0.2.6/pyproject.toml`
...
### Comparing `forust-0.2.5/scratch.py` & `forust-0.2.6/scratch.py`
...
### Comparing `forust-0.2.5/src/lib.rs` & `forust-0.2.6/src/lib.rs`
...
### Comparing `forust-0.2.5/tests/test_booster.py` & `forust-0.2.6/tests/test_booster.py`
...
### Comparing `forust-0.2.5/LICENSE` & `forust-0.2.6/LICENSE`
...
### Comparing `forust-0.2.5/PKG-INFO` & `forust-0.2.6/README.md`
