# Comparing `tmp/fsst-0.8.2.tar.gz` & `tmp/fsst-0.8.3.tar.gz`
...
## Comparing `fsst-0.8.2.tar` & `fsst-0.8.3.tar`
...
### Comparing `fsst-0.8.2/PKG-INFO` & `fsst-0.8.3/PKG-INFO`
...
### Comparing `fsst-0.8.2/README.md` & `fsst-0.8.3/README.md`

 * *Files identical despite different names*

### Comparing `fsst-0.8.2/fsst.egg-info/PKG-INFO` & `fsst-0.8.3/fsst.egg-info/PKG-INFO`
...
### Comparing `fsst-0.8.2/fsst.py` & `fsst-0.8.3/fsst.py`
...
### Comparing `fsst-0.8.2/setup.py` & `fsst-0.8.3/setup.py`
