# Comparing `tmp/hlatypingtools-1.0.5.tar.gz` & `tmp/hlatypingtools-1.0.6.tar.gz`
...
+gzip compressed data, was "hlatypingtools-1.0.6.tar", max compression
```

## Comparing `hlatypingtools-1.0.5.tar` & `hlatypingtools-1.0.6.tar`
...
+-rw-r--r--   0        0        0       59 2023-04-15 19:16:13.832019 hlatypingtools-1.0.6/hlatypingtools/__init__.py
+-rw-r--r--   0        0        0   180071 2023-05-09 14:31:20.693341 hlatypingtools-1.0.6/hlatypingtools/data/data.pickle.aes
+-rw-r--r--   0        0        0      816 2023-04-18 09:05:19.478359 hlatypingtools-1.0.6/hlatypingtools/decrypt_file.py
+-rw-r--r--   0        0        0     3056 2023-04-26 13:39:18.239729 hlatypingtools-1.0.6/hlatypingtools/get_info.py
+-rw-r--r--   0        0        0      529 2023-05-09 14:33:53.935154 hlatypingtools-1.0.6/pyproject.toml
+-rw-r--r--   0        0        0     2807 2023-04-15 19:16:52.738119 hlatypingtools-1.0.6/README.md
+-rw-r--r--   0        0        0     3557 1970-01-01 00:00:00.000000 hlatypingtools-1.0.6/setup.py
+-rw-r--r--   0        0        0     3265 1970-01-01 00:00:00.000000 hlatypingtools-1.0.6/PKG-INFO
```

### Comparing `hlatypingtools-1.0.5/hlatypingtools/decrypt_file.py` & `hlatypingtools-1.0.6/hlatypingtools/decrypt_file.py`

 * *Files identical despite different names*

### Comparing `hlatypingtools-1.0.5/hlatypingtools/get_info.py` & `hlatypingtools-1.0.6/hlatypingtools/get_info.py`

 * *Files identical despite different names*

### Comparing `hlatypingtools-1.0.5/pyproject.toml` & `hlatypingtools-1.0.6/pyproject.toml`
...
### Comparing `hlatypingtools-1.0.5/README.md` & `hlatypingtools-1.0.6/README.md`

 * *Files identical despite different names*

### Comparing `hlatypingtools-1.0.5/setup.py` & `hlatypingtools-1.0.6/setup.py`
...
### Comparing `hlatypingtools-1.0.5/PKG-INFO` & `hlatypingtools-1.0.6/PKG-INFO`
